...
RUN echo "Installing PHP extensions" \
    && docker-php-ext-install -j$(nproc) iconv mcrypt gd pdo_mysql pcntl zip curl bcmath opcache simplexml xmlrpc xml soap session readline pspell mbstring intl \
